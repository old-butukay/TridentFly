...
public class ModMenu implements ModMenuApi {
    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return parent -> {
            ...
            settings.addEntry(entryBuilder.startIntSlider(new TranslatableText("option.trident-fly.use-ticks"), TridentFly.getConfig().getUseTicks(), 1, 10)
                .setSaveConsumer(integer -> TridentFly.getConfig().setUseTicks(integer))
                .build());
